...
Supports dry-run preview and automatic creation of destination folders.`,
		Options: []string{
			...
			"--date-granularity   Date folder granularity: year (default), month (Jan folders), day",
			"--month-format       Month folder format for --date and {month}: name (default, Jan), number (01)",
		...
		Examples: []string{
			...
			"chest sort --date --date-granularity month        Group by modification year/month using month names, e.g. 2025/Jan/",
			"chest sort --date --date-granularity month --month-format number  Same grouping with numeric months, e.g. 2025/01/",
		...
		Concepts: []string{
			"CATEGORY MODES  -t/--type, -f/--format, -s/--size and -d/--date split a batch into MULTIPLE category folders (Images/, MP4/, Large Files/, 2024/, 2025/, 2026/). --date defaults to modification year; use --date-source auto and --date-granularity month|day for embedded media dates and finer folders. Month folders use names (2025/Jan/) by default; pass --month-format number for 2025/01/.",
